...
function BrandPanel() {
  return (
    <aside className="relative hidden lg:flex flex-col justify-between overflow-hidden text-white bg-gradient-to-br from-slate-950 via-emerald-950 to-primary-950">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 -left-24 w-[28rem] h-[28rem] rounded-full bg-emerald-500/25 blur-3xl" />
        <div className="absolute -bottom-40 -right-24 w-[28rem] h-[28rem] rounded-full bg-primary-500/25 blur-3xl" />
        <div
      ...
      <div className="relative z-10 p-12 flex flex-col h-full">
        ...
        <div className="space-y-6 max-w-md my-auto py-10">
          ...
          <h2 className="text-4xl font-bold leading-tight">
            Tenha{' '}
            <span className="bg-gradient-to-r from-emerald-300 via-primary-300 to-violet-300 bg-clip-text text-transparent">
              controle total
            </span>{' '}
            das suas finanças.
          </h2>
          <p className="text-white/70 text-base leading-relaxed">
            Crie sua conta gratuitamente e descubra quanto antes o impacto de cada decisão no seu saldo.
          </p>

          <ul className="space-y-3 pt-2">
            {[
              { icon: LineChart, title: 'Projeção mês a mês', desc: 'Antecipe seu saldo com gráficos claros.' },
              { icon: Target, title: 'Metas com juros reais', desc: 'Investimentos com taxa configurável.' },
              { icon: ShieldCheck, title: 'Privacidade em primeiro lugar', desc: 'Seus dados ficam só com você.' },
        ...
        {/* Lista de benefícios */}
        <div className="relative rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur-md p-4 shadow-2xl">
          <div className="text-xs font-semibold text-white/80 mb-3">No plano gratuito você tem</div>
          <ul className="space-y-2 text-sm">
            {['Contas e transações ilimitadas', 'Projeção financeira', 'Metas e investimentos'].map((b) => (
        ...
        <main className="flex items-center justify-center p-6 sm:p-10 bg-gray-50 dark:bg-gray-950">
          <div className="w-full max-w-md">
            ...
            <div className="relative">
              <div className="absolute -top-3 left-8 right-8 h-1 rounded-full bg-gradient-to-r from-emerald-500 via-primary-500 to-violet-500" />
